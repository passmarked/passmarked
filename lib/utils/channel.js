...
module.exports = exports = function() {
  ...
  **/
  Channel.checkLastPing = function() {
    ...
    if(waitingPeriod > 1000 * Constants.TIMEOUT) {

        // close the channel
        return Channel.handleCallback(new Error('Connection has been inactive (and missing pings from server) for more than ' + Constants.TIMEOUT + ' seconds'));
  ...
  **/
  Channel.connect = function() {
    ...
    clientSocket = new WebSocket(Constants.WSS_URL);
