...
module.exports = require('yargs')
  ...
  .describe('restart', 'Restarts the tunnel if it goes down')
  ...
  .string('token')
  .default('token', null)
  .describe('token', 'Override and set a server side token to use')
  ...
  .default('p', false)
  .alias('p', 'pattern')
  .describe('p', 'Regex patterns to whitelist in the crawl, separated by comma')
  ...
  .default('limit', null)
  .alias('limit', 'l')
  .describe('limit', 'Path to read targets from')
