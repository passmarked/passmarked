...
module.exports = exports = function(payload, fn) {
  ...
  config.build(function(){
    ...
    var integrationURL  = Constants.WEB_URL + '/grant';

    // switch to beta
    if(payload.getArguments().beta === true)
      integrationURL = Constants.BETA_WEB_URL + '/grant';
      ...
      api.user({
        ...
        if( response.status != 'ok' ) {
          ...
          return api.track({
            ...
            // show the error
            payload.error('Was not able to verify token ...');
