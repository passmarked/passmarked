...
API.getStatusOfReport = function(params, fn) {
  ...
  API.request({
      ...
      url:    Constants.API_URL + '/v2/reports/' + params.key + '/status',
      method: 'GET'
...
API.getOccurrences = function(params, fn) {
  ...
  API.request({
      ...
      url:    Constants.API_URL + '/v2/reports/' + params.key + '/occurrences?' + querystring.stringify(params),
      method: 'GET'
...
API.getIssues = function(params, fn) {
  ...
  API.request({
      ...
      url:    Constants.API_URL + '/v2/reports/' + params.key + '/issues?' + querystring.stringify(params),
      method: 'GET'
