...
**/
API.submitCrawl = function(websiteid, fn) {
  ...
  config.build(function(err){
    ...
    API.request({
        ...
        url: Constants.API_URL + '/v1/websites/' + websiteid + '/crawls',
        method: 'POST',
        form: {
...
API.submit = function(url, fn) {
  ...
  config.build(function(err){
    ...
    API.request({
        ...
        url: Constants.API_URL + '/v1/submit?' + querystring.stringify({
