...
* the DNS protection from Passmarked spot malicious DNS hijacking
**/
API.resolve = function(params, fn) {
  ...
  API.request({
    ...
    url:      config.getAPIURL('/v2/resolve'),
    method:   'POST',
    form:     params
...
API.result = function(params, fn) {
  ...
  API.request({
    ...
    url:      config.getAPIURL('/v2/result'),
    method:   'POST',
    form:     params
...
API.track = function(params, fn) {
  ...
  API.request({
    ...
    url:      config.getAPIURL('/v2/events'),
    method:   'POST',
    form:     params
...
API.websites = function(params, fn) {
  ...
  API.request({
      ...
      url: config.getAPIURL('/v2/websites?' + querystring.stringify({
...
API.website = function(params, fn) {
  ...
  API.request({
      ...
      url: config.getAPIURL('/v2/websites/' + params.id + '?' + querystring.stringify({
...
/**
* Returns the status of report, this is a minimal dataset
* being returned to allow for easy polling.
**/
API.getStatusOfReport = function(params, fn) {

  // do the request
  API.request({

      url:    config.getAPIURL('/v2/reports/' + params.key + '/status'),
      method: 'GET'
...
/**
* Returns occurrences of a report, max 20 at a time
**/
API.getOccurrences = function(params, fn) {
  ...
  API.request({
      ...
      url:    config.getAPIURL('/v2/reports/' + params.key + '/occurrences?' + querystring.stringify(params)),
      method: 'GET'
...
API.getIssues = function(params, fn) {
  ...
  API.request({
      ...
      url:    config.getAPIURL('/v2/reports/' + params.key + '/issues?' + querystring.stringify(params)),
      method: 'GET'
...
API.get = function(params, fn) {
  ...
  API.request({
      ...
      url:    config.getAPIURL('/v2/reports/' + params.key),
      method: 'GET'
...
API.balance = function(params, fn) {
  ...
  API.request({
      ...
      url: config.getAPIURL('/v2/balance?' + querystring.stringify({
...
API.user = function(params, fn) {
  ...
  API.request({
      ...
      url: config.getAPIURL('/v2/user?' + querystring.stringify({
...
API.subscribe = function(params, fn) {
  ...
  API.request({
      ...
      url: config.getAPIURL('/v2/subscribe'),
      method: 'POST',
      form: {
...
API.submitCrawl = function(params, fn) {
  ...
  API.request({
      ...
      url: config.getAPIURL('/v2/reports'),
      method: 'POST',
      form: {
