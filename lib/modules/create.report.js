  ...
  Report.start    = function(fn) {
    ...
    Report.getTargetIP(this.getURL(), (err, address) => {
      ...
      Validate.isLocalIP(address, (err, localResult) => {
        ...
        var bootReport = (params, bootCallback) => {
          ...
          // check if the tunnel was given
          if(S(params.tunnel).isEmpty() === false) {

            // set the target
            startParams.proxy = params.tunnel;
        ...
        channel.once('ready', _.bind(function() {
          ...
          if(localResult === true) {
            ...
            ngrok.connect({
              ...
              addr:     uri.host, // port or network address
              ...
              if(err) {
                ...
                // done
                return fn(new Error('Problem setting up tunnel to ' + uri.host));
