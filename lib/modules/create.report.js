...
module.exports = exports = function(params) {
  ...
  **/
  Report.prefixProtocol = function(url) {
    ...
    // already has the protocol, just return it
    return url;
        ...
        channel.once('ready', _.bind(function() {
          ...
          if(localResult === true) {
            ...
            request({
              ...
              // check for a url
              if(err)
                return fn(new Error('Could not connect to ' + localRefURL));
              ...
              if(resp &&
                ...
                // nope
                return fn(new Error(localRefURL + ' returned status code ' + resp.statusCode));
              ...
              ngrok.connect({
                ...
                if(err) {
                  ...
                  // done
                  return fn(new Error('Failed to setup tunnel to ' + localResult));
